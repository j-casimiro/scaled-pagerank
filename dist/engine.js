...
class SearchResolver {
     ...
     */
    constructor(pages, invertedIndex, stopWords) {
        this.pages = pages;
     ...
     */
    search(query, pagerankVector, alpha, mode) {
...
window.PageRankSolver = PageRankSolver;
window.SearchResolver = SearchResolver;
